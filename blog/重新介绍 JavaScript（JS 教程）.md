...
> 转载于https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview
...
## [概览](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#概览)
...
## [数字](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#数字)

根据语言规范，JavaScript 采用“遵循 IEEE 754 标准的双精度 64 位格式”（"double-precision 64-bit format IEEE 754 values"）表示数字。——在 JavaScript（除了[`BigInt`](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/BigInt)）当中，**并不存在整数/整型 (Integer)。**因此在处理如下的场景时候，您一定要小心：
...
## [字符串](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#字符串)
...
## [其他类型](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#其他类型)
...
## [变量](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#变量)
...
## [运算符](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#运算符)
...
## [控制结构](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#控制结构)
...
## [对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#对象)
...
## [数组](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#数组)
...
## [函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#函数)
...
## [自定义对象](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#自定义对象)

**备注：** 关于 JavaScript 中面向对象编程更详细的信息，请参考 [JavaScript 面向对象简介 (en-US)](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects)。
...
### [内部函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Language_Overview#内部函数)
